...
$contenido_pruebas = array(
	...
	"Proxy(Bono)" => array(
		...
		"opciones" => array("objetivo_prueba" => "Objetivo de prueba",
							"servidores_bono" => "Servidores Bono en este despliegue",
							"primer_numero" => "Extensiones inicial a usar",
							"numero_de_extensiones" => "Número de extensiones a usar",
							"dominio" => "Dominio")
	),
	"Core IMS (Sprout)" => array(
		...
		"opciones" => array("dominio" => "Dominio", 
							"numero_suscriptores" => "Número de suscriptores",
							"duracion_llamada" => "Duración en minutos de la llamada",
							"registros_segundo" => "Registros por segundo",
							"mostrar_en _pantalla" => "Mostrar pruebas en pantalla",
							"cambiar_icscf" => "Cambiar I-CSCF",
							"cambiar_scscf" => "Cambiar S-CSCF" )
	),
	"Prueba en Vivo" => array(
		...
		"opciones" => array(
			...
			"IBCF" => "Direccion del nodo BGCF",
			// "ICSCF_HOSTNAME=<hostname>" => "Nombre de ICSCF",
			"ICSCF_HOSTNAME" => "Nombre de ICSCF",
			// "EMERGENCY_REG=Y" => "Incluye pruebas con registración de emergencia",
			"EMERGENCY_REG" => "Incluye pruebas con registración de emergencia",
			// "SHORT_REG=Y" => "Incluir pruebas que usen regisstracion corta",
			"SHORT_REG" => "Incluir pruebas que usen regisstracion corta",
			// "PCSCF=<PROXY or B2BUA>" => "Nombre del PCSCF")		
			"PCSCF" => "Nombre del PCSCF")		
	)	
);
