...
ssh -o "StrictHostKeyChecking no" -i /var/www/html/telco/scripts/Testbed_vIMS.pem ubuntu@$1 "sudo sed -i '$a agentAddress udp:161,udp6:[::1]:161' /etc/snmp/snmpd.conf"
ssh -o "StrictHostKeyChecking no" -i /var/www/html/telco/scripts/Testbed_vIMS.pem ubuntu@$1 "sudo service snmpd restart"
#ssh -o "StrictHostKeyChecking no" -i /var/www/html/telco/scripts/Testbed_vIMS.pem ubuntu@$1 "sudo apt-get update"
#ssh -o "StrictHostKeyChecking no" -i /var/www/html/telco/scripts/Testbed_vIMS.pem ubuntu@$1 "sudo apt-get -y install openssl;"
#ssh -o "StrictHostKeyChecking no" -i /var/www/html/telco/scripts/Testbed_vIMS.pem ubuntu@$1 "sudo apt-get -y install shellinabox"